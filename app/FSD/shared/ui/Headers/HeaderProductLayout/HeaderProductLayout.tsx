...
import styles from './HeaderProductLayout.module.scss';

export default function HeaderProductLayout() {
  return (
    <header className={styles.header}>
      ...
      <Link to="/#" className={styles.link}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="11.5788" cy="7.27803" r="4.77803" stroke="#3C4149" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
